...
// Compartido entre /admin/tarifas y /reception/tarifas — mismo formulario,
// mismo permiso en el backend (admin + reception), solo cambia el
// DashboardShell (título/nav) que lo envuelve en cada rol.
